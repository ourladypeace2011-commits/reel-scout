...
**目前版本**：**v1.3.1** ｜ **測試**：**1056 passing**（2026-09-03 於本支實跑）｜ **DB schema**：**v17**

> 基準寫清楚免得下一個人重數：`master` 1047 ＋ 本支 9 ＝ **1056**。schema **v17**（v14 `shots`／v15 `shot_labels`／v16 `translations`／v17 `shot_labels.prompt_hash`）。
>
